...
const content = {
  ...
  ka: {
    ...
    intro: {
      ...
      body: "მარნში ღვინის დეგუსტაციიდან აჯამეთში ცხენოსნობამდე — შატო ვარციხე შექმნილია სტუმრებისთვის, რომლებსაც მოსვენებასთან ერთად მეტის გაკეთება სურთ. ნაწილი აქტივობები უფასოა, ნაწილი ფასიანი — მიმართეთ რეცეფციას ან დაგვიკავშირდით.",
    },
    highlights: [
      {
        title: "ცხენოსნობა",
      ...
      {
        title: "ტბა",
        body: "ნავით გასეირნება და თევზაობა მამულის კერძო ტბაზე, ხოლო ხიდულიდან შეგიძლიათ ჩაესვენოთ მზის ჩასვლას წყალზე.",
        img: "/assets/photos/activities/lake-rowboat.jpg",
      },
    ],
    cta: {
